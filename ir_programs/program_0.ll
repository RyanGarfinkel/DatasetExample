...
define i32 @FLA_Trsm_llt_blk_var2(i32 noundef %diagA, ptr noundef byval(%struct.FLA_Obj_view) align 8 %alpha, ptr noundef byval(%struct.FLA_Obj_view) align 8 %A, ptr noundef byval(%struct.FLA_Obj_view) align 8 %B, ptr noundef %cntl) #0 {
entry:
...
while.body:                                       ; preds = %while.cond
  ...
  %7 = load i32, ptr %diagA.addr, align 4
  %8 = load ptr, ptr %cntl.addr, align 8
  %sub_trsm = getelementptr inbounds %struct.fla_trsm_s, ptr %8, i32 0, i32 4
  %9 = load ptr, ptr %sub_trsm, align 8
  %call8 = call i32 @FLA_Trsm_internal(i32 noundef 210, i32 noundef 300, i32 noundef 401, i32 noundef %7, ptr noundef byval(%struct.FLA_Obj_view) align 8 @FLA_ONE, ptr noundef byval(%struct.FLA_Obj_view) align 8 %A11, ptr noundef byval(%struct.FLA_Obj_view) align 8 %B1, ptr noundef %9)
  %10 = load ptr, ptr %cntl.addr, align 8
  %sub_gemm = getelementptr inbounds %struct.fla_trsm_s, ptr %10, i32 0, i32 5
  %11 = load ptr, ptr %sub_gemm, align 8
  %call9 = call i32 @FLA_Gemm_internal(i32 noundef 401, i32 noundef 400, ptr noundef byval(%struct.FLA_Obj_view) align 8 @FLA_MINUS_ONE, ptr noundef byval(%struct.FLA_Obj_view) align 8 %A10, ptr noundef byval(%struct.FLA_Obj_view) align 8 %B1, ptr noundef byval(%struct.FLA_Obj_view) align 8 @FLA_ONE, ptr noundef byval(%struct.FLA_Obj_view) align 8 %B0, ptr noundef %11)
